      ...
      <div :key="currentStep" class="game-help__content">
        ...
        <h2 class="game-help__title gutenku-text-primary">
          <template v-if="currentStep === 0">
            {{ t('game.help.welcomeTo') }}
            <span class="game-help__brand">
              <span class="game-help__brand-guten">Guten</span
              ><span class="game-help__brand-guess">Guess</span>
            </span>
          </template>
          <template v-else>
        ...
        >
          ...
          <div class="lifeline-item">
            <Filter :size="20" class="lifeline-icon lifeline-icon--filter" />
            <span
              class="lifeline-text"
              >{{ t('game.help.step3Lifeline3') }}</span
            >
          </div>
...
.game-help__brand-guten {
  font-family: 'JMH Typewriter', serif;
  font-weight: 400;
  color: var(--gutenku-zen-primary);
}

.game-help__brand-guess {
...
.lifeline-icon {
  ...
  &--filter {
    ...
    filter: drop-shadow(0 0 4px oklch(0.55 0.12 200 / 0.4));
  }
}
