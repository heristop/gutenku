  ...
  <header class="game-header">
    <div class="header-content">
      ...
      <div class="header-left">
        <h1 class="game-title">
          <span class="visually-hidden">GutenGuess</span>
          <span aria-hidden="true" class="game-title__guten">Guten</span
          ><span aria-hidden="true" class="game-title__guess">Guess</span>
        </h1>
      </div>
