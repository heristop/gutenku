...
export default {
    async createPng(verses: string[]) {
        ...
        const colors = ['#E57373', '#F48FB1', '#CE93D8', '#D1C4E9', '#9FA8DA', '#90CAF9', '#81D4FA', '#80CBC4', '#A5D6A7', '#BCAAA4'];
        ...
        //background.src = './src/assets/img/pf-s100-a02-mockup.jpg';
